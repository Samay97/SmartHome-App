...
function ColorPickerControl(cfg) {
        ...
        root.innerHTML = `
            ...
            <div class="color-picker-controls">
                <div class="color-picker-controls-group" style="display: flex; flex-direction: row;">
                    ...
                    <div class="color-picker-brightness-control" style="height: 240px;">
                ...
                <div class="color-picker-controls-group" style="flex: 1; padding-top: 0; display: none;">
    ...
    this.setNewColorFromRGB = function (r, g, b) {
      const color = new HSVaColor().fromRGBa(r, g, b);
      this.color = color;
      this.update();
    }
